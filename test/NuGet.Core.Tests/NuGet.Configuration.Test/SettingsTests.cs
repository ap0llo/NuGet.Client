...
<configuration>
    <SectionName>
        ...
        // TODO-PATO: test remove value - value that overrides a machine wide, removes value but not machine wide
        // TODO-PATO: test remove value - machine wide returns false
        // TODO-PATO: test remove value - last value in section removes section
        // TODO-PATO: test remove value - last value in section of that config, removes section on that config
        // TODO-Pato: test remove value - removes values in all configs expect machine wide
