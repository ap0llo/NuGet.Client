        ...
        public void LoadPackageSourcesIgnoresInvalidCredentialPairsFromSettings(string userName, string password)
        {
            ...
            settings
             ...
             .Returns(new SettingsSection("two",
                 new CredentialsItem("two", userName, password, isPasswordClearText: false)
                 ));
...
<configuration>
                ...
                children[0].Value.Should().Be("one");
                children[0].ProtocolVersion.Should().BeNullOrEmpty();
                children[0].Key.Should().Be("two");
                children[0].Value.Should().Be("two");
                children[0].ProtocolVersion.Should().BeNullOrEmpty();
                children[0].Key.Should().Be("three");
                children[0].Value.Should().Be("three");
                children[0].ProtocolVersion.Should().BeNullOrEmpty();
...
<configuration>
    <packageSources>
        <add key=""Source2-Name"" value=""Legacy-Source"" />
                ...
                var children = packageSourcesSection.Children.Select(c => c as SourceItem).ToList();
                children[0].Key.Should().Be("Source1-Name");
                children[0].Value.Should().Be("Source1");
                children[0].ProtocolVersion.Should().BeNullOrEmpty();
                children[0].Key.Should().Be("Source2-Name");
                children[0].Value.Should().Be("Legacy-Source");
                children[0].ProtocolVersion.Should().BeNullOrEmpty();
                children[0].Key.Should().Be("Source2-Name");
                children[0].Value.Should().Be("Source2");
                children[0].ProtocolVersion.Should().Be("3");
...
<configuration>
                ...
                children[0].Value.Should().Be("one");
                children[0].ProtocolVersion.Should().BeNullOrEmpty();
                children[0].Key.Should().Be("twoname");
                children[0].Value.Should().Be("http://twosource");
                children[0].ProtocolVersion.Should().BeNullOrEmpty();
                children[0].Key.Should().Be("three");
                children[0].Value.Should().Be("three");
                children[0].ProtocolVersion.Should().BeNullOrEmpty();
                ...
                disabledPackageSourcesSection.Should().NotBeNull();
                disabledPackageSourcesSection.Children.Count.Should().Be(1);
                var two = disabledPackageSourcesSection.Children.FirstOrDefault() as CredentialsItem;
                two.Should().NotBeNull();
