...
namespace NuGet.Configuration
{
    public sealed class SettingsTextContent : SettingsNode, IEquatable<SettingsTextContent>
    {
        ...
        public bool DeepEquals(SettingsTextContent other)
        {
            return Equals(other);
        }

        public override bool DeepEquals(SettingsNode other)
        {
            return Equals(other as SettingsTextContent);
        }

        public override bool Equals(SettingsNode other)
        {
            return Equals(other as SettingsTextContent);
        }
