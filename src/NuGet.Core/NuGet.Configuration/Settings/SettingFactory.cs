...
namespace NuGet.Configuration
{
    internal static class SettingFactory
    {
        internal static SettingsNode Parse(XNode node, ISettingsFile origin)
        {
            ...
            {
                if (string.Equals(element.Name.LocalName, ConfigurationConstants.Add))
                {
                    if (string.Equals(element.Parent?.Name.LocalName, ConfigurationConstants.PackageSources))
                    {
                ...
                else if (string.Equals(element.Parent?.Name.LocalName, ConfigurationConstants.CredentialsSectionName))
                {
